...
class TestSessionCreation:
    ...
    def test_create_session_endpoint_exists(self, session_client: TestClient) -> None:
    ...
    def test_create_session_returns_session_id(self, session_client: TestClient) -> None:
...
class TestSessionDeletion:
    ...
    def test_delete_nonexistent_session(self, session_client: TestClient) -> None:
    ...
    def test_delete_session_requires_id(self, session_client: TestClient) -> None:
...
class TestSessionPoolStats:
    ...
    def test_pool_stats_endpoint(self, session_client: TestClient) -> None:
...
class TestSessionWithRequests:
    ...
    def test_session_header_accepted(self, session_client: TestClient) -> None:
...
class TestConfigEndpoint:
    ...
    def test_config_endpoint_returns_settings(self, session_client: TestClient) -> None:
    ...
    def test_config_hides_secrets(self, session_client: TestClient) -> None:
