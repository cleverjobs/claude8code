...
class TestMessagesEndpoint:
    ...
    def test_simple_message_request(self, client: TestClient, sample_messages_request):
        """Test a simple non-streaming message request."""
        response = client.post(
            "/v1/messages",
            json=sample_messages_request,
    ...
    def test_message_with_system_prompt(self, client: TestClient):
    ...
    def test_invalid_request_missing_messages(self, client: TestClient):
    ...
    def test_invalid_request_missing_model(self, client: TestClient):
...
class TestSessionEndpoints:
    ...
    def test_delete_nonexistent_session(self, client: TestClient):
        ...
        response = client.delete(
            "/v1/sessions/nonexistent-session-id",
            headers={"x-api-key": "sk-test"}
        )
...
class TestResponseFormat:
    ...
    def test_response_has_anthropic_fields(self, client: TestClient, sample_messages_request):
    ...
    def test_usage_has_token_counts(self, client: TestClient, sample_messages_request):
